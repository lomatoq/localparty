...
- The interface is primarily Russian. This release remains an alpha; browser and device differences can affect performance and input behavior.
...
Release identifier: `0.6.0-alpha`.
