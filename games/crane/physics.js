...
class TowerPhysics{
 ...
 add(x,y,metadata={}){const body=this.world.createRigidBody(RAPIER.RigidBodyDesc.dynamic().setTranslation(x/SCALE,y/SCALE).setLinearDamping(.3).setAngularDamping(1.2).setAdditionalSolverIterations(12).setCcdEnabled(true));const collider=this.world.createCollider(RAPIER.ColliderDesc.cuboid(WIDTH/2/SCALE,HEIGHT/2/SCALE).setFriction(.95).setRestitution(.005).setDensity(1),body);const block={body,collider,...metadata};this.blocks.push(block);return block;}
