...
const fields={
 marble_bloom:[choice('mode','Режим',[['coop','Вместе'],['versus','Друг против друга']],'coop'),choice('levels','Уровни',[1,3,6],3)],
 pocket_siege:[choice('rounds','Ходы',[5,10,15],10),choice('sandbox','Арсенал',[['false','Набор на матч'],['true','Все оружия · бесконечно']],'false'),choice('draftMode','Выбор перед матчем',[['false','Случайная выдача'],['true','Игроки собирают арсенал']],'false'),choice('teams','Команды',[['false','Каждый за себя'],['true','По командам']],'false')],
 bow_club:[choice('mode','Режим',[['versus','Каждый за себя'],['teams','По командам'],['coop','Вместе']],'versus'),choice('arrows','Стрелы',[5,10,15],10)],
