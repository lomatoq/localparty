...
const base=process.env.PARTY_TEST_ORIGIN||'http://127.0.0.1:8080',key=process.env.PARTY_TEST_KEY||'localparty-integration-test';
...
(async()=>{let input;try{
 ...
 await manage({type:'server-stop'});console.log('PASS iPhone 16-player load');
